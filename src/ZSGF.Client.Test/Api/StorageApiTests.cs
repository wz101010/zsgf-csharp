...
namespace ZSGF.Client.Test.Api
{
    ...
    public sealed class StorageApiTests : ApiTestsBase
    {
        ...
        /// <summary>
        /// Test StorageBatchUpdate
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task StorageBatchUpdateAsyncTest()
        {
            string table = default;
            ...
            var response = await _instance.StorageBatchUpdateAsync(table, filter, appKey, requestBody, replace);
            var model = response.Ok();
