...
namespace ZSGF.Client.Model
{
    ...
    public partial class AccessTokenPutRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AccessTokenPutRequest(string title, Option<string> tags = default, Option<string> description = default, Option<string> permissions = default, Option<bool?> enable = default)
        {
            Title = title;
            TagsOption = tags;
