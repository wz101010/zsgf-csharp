...
namespace ZSGF.Client.Model
{
    ...
    public partial class AccessTokenPutRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="title">访问令牌的标题 (default to &quot;默认标题&quot;)</param>
        ...
        /// <param name="enable">是否启用访问令牌 (default to false)</param>
        [JsonConstructor]
        public AccessTokenPutRequest(string title = @"默认标题", Option<string> tags = default, Option<string> description = default, Option<string> permissions = default, Option<bool?> enable = default)
        {
            Title = title;
            TagsOption = tags;
    ...
    public class AccessTokenPutRequestJsonConverter : JsonConverter<AccessTokenPutRequest>
    {
        ...
        public override AccessTokenPutRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!title.IsSet)
                throw new ArgumentException("Property is required for class AccessTokenPutRequest.", nameof(title));

            if (title.IsSet && title.Value == null)
                throw new ArgumentNullException(nameof(title), "Property is not nullable for class AccessTokenPutRequest.");

            if (enable.IsSet && enable.Value == null)
                throw new ArgumentNullException(nameof(enable), "Property is not nullable for class AccessTokenPutRequest.");

            return new AccessTokenPutRequest(title.Value, tags, description, permissions, enable);
        }
        ...
        {
            if (accessTokenPutRequest.Title == null)
                throw new ArgumentNullException(nameof(accessTokenPutRequest.Title), "Property is required for class AccessTokenPutRequest.");
