...
namespace ZSGF.Client.Model
{
    ...
    public partial class GeoLocationResponseModel : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GeoLocationResponseModel(Option<double?> latitude = default, Option<double?> longitude = default, Option<string> locationName = default, Option<string> locationType = default, Option<string> recipientName = default, Option<string> phoneNumber = default, Option<string> email = default, Option<string> country = default, Option<string> state = default, Option<string> city = default, Option<string> district = default, Option<string> street = default, Option<string> zipCode = default, Option<string> address = default, Option<string> mapType = default, Option<string> remark = default, Option<string> tags = default, Option<bool?> enable = default, Option<int?> showIndex = default, Option<DateTime?> createDate = default, Option<DateTime?> lastUpdate = default, Option<int?> id = default)
        {
    ...
    public class GeoLocationResponseModelJsonConverter : JsonConverter<GeoLocationResponseModel>
    {
        ...
        public override GeoLocationResponseModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (enable.IsSet && enable.Value == null)
                throw new ArgumentNullException(nameof(enable), "Property is not nullable for class GeoLocationResponseModel.");

            if (showIndex.IsSet && showIndex.Value == null)
                throw new ArgumentNullException(nameof(showIndex), "Property is not nullable for class GeoLocationResponseModel.");
            ...
            return new GeoLocationResponseModel(latitude, longitude, locationName, locationType, recipientName, phoneNumber, email, country, state, city, district, street, zipCode, address, mapType, remark, tags, enable, showIndex, createDate, lastUpdate, id);
        }
        ...
        {
            if (geoLocationResponseModel.LatitudeOption.IsSet)
                writer.WriteNumber("latitude", geoLocationResponseModel.LatitudeOption.Value.Value);

            if (geoLocationResponseModel.LongitudeOption.IsSet)
                writer.WriteNumber("longitude", geoLocationResponseModel.LongitudeOption.Value.Value);
            ...
            if (geoLocationResponseModel.LocationTypeOption.IsSet)
                if (geoLocationResponseModel.LocationTypeOption.Value != null)
