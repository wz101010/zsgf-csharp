...
namespace ZSGF.Client.Model
{
    ...
    /// </summary>
    public partial class GeoLocationResponseModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeoLocationResponseModel" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public GeoLocationResponseModel(double latitude, double longitude, string locationType, Option<string> locationName = default, Option<string> recipientName = default, Option<string> phoneNumber = default, Option<string> email = default, Option<string> country = default, Option<string> state = default, Option<string> city = default, Option<string> district = default, Option<string> street = default, Option<string> zipCode = default, Option<string> address = default, Option<string> mapType = default, Option<string> remark = default, Option<string> tags = default, Option<bool?> enable = default, Option<int?> showIndex = default, Option<DateTime?> createDate = default, Option<DateTime?> lastUpdate = default, Option<int?> id = default)
        {
            Latitude = latitude;
            Longitude = longitude;
    ...
    /// <summary>
    /// A Json converter for type <see cref="GeoLocationResponseModel" />
    /// </summary>
    public class GeoLocationResponseModelJsonConverter : JsonConverter<GeoLocationResponseModel>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="GeoLocationResponseModel" />
        /// </summary>
        ...
        public override GeoLocationResponseModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!latitude.IsSet)
                throw new ArgumentException("Property is required for class GeoLocationResponseModel.", nameof(latitude));

            if (!longitude.IsSet)
                throw new ArgumentException("Property is required for class GeoLocationResponseModel.", nameof(longitude));

            if (!locationType.IsSet)
                throw new ArgumentException("Property is required for class GeoLocationResponseModel.", nameof(locationType));

            if (latitude.IsSet && latitude.Value == null)
                throw new ArgumentNullException(nameof(latitude), "Property is not nullable for class GeoLocationResponseModel.");

            if (longitude.IsSet && longitude.Value == null)
                throw new ArgumentNullException(nameof(longitude), "Property is not nullable for class GeoLocationResponseModel.");

            if (locationType.IsSet && locationType.Value == null)
                throw new ArgumentNullException(nameof(locationType), "Property is not nullable for class GeoLocationResponseModel.");

            if (createDate.IsSet && createDate.Value == null)
                throw new ArgumentNullException(nameof(createDate), "Property is not nullable for class GeoLocationResponseModel.");

            if (lastUpdate.IsSet && lastUpdate.Value == null)
                throw new ArgumentNullException(nameof(lastUpdate), "Property is not nullable for class GeoLocationResponseModel.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class GeoLocationResponseModel.");

            return new GeoLocationResponseModel(latitude.Value.Value, longitude.Value.Value, locationType.Value, locationName, recipientName, phoneNumber, email, country, state, city, district, street, zipCode, address, mapType, remark, tags, enable, showIndex, createDate, lastUpdate, id);
        }

        /// <summary>
        /// Serializes a <see cref="GeoLocationResponseModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="geoLocationResponseModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GeoLocationResponseModel geoLocationResponseModel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, geoLocationResponseModel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GeoLocationResponseModel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="geoLocationResponseModel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GeoLocationResponseModel geoLocationResponseModel, JsonSerializerOptions jsonSerializerOptions)
        {
            if (geoLocationResponseModel.LocationType == null)
                throw new ArgumentNullException(nameof(geoLocationResponseModel.LocationType), "Property is required for class GeoLocationResponseModel.");

            writer.WriteNumber("latitude", geoLocationResponseModel.Latitude);

            writer.WriteNumber("longitude", geoLocationResponseModel.Longitude);

            writer.WriteString("locationType", geoLocationResponseModel.LocationType);

            if (geoLocationResponseModel.LocationNameOption.IsSet)
                if (geoLocationResponseModel.LocationNameOption.Value != null)
                    writer.WriteString("locationName", geoLocationResponseModel.LocationName);
                else
                    writer.WriteNull("locationName");

            if (geoLocationResponseModel.RecipientNameOption.IsSet)
                if (geoLocationResponseModel.RecipientNameOption.Value != null)
                    writer.WriteString("recipientName", geoLocationResponseModel.RecipientName);
                else
                    writer.WriteNull("recipientName");

            if (geoLocationResponseModel.PhoneNumberOption.IsSet)
                if (geoLocationResponseModel.PhoneNumberOption.Value != null)
                    writer.WriteString("phoneNumber", geoLocationResponseModel.PhoneNumber);
                else
                    writer.WriteNull("phoneNumber");

            if (geoLocationResponseModel.EmailOption.IsSet)
                if (geoLocationResponseModel.EmailOption.Value != null)
                    writer.WriteString("email", geoLocationResponseModel.Email);
                else
                    writer.WriteNull("email");

            if (geoLocationResponseModel.CountryOption.IsSet)
                if (geoLocationResponseModel.CountryOption.Value != null)
                    writer.WriteString("country", geoLocationResponseModel.Country);
                else
                    writer.WriteNull("country");

            if (geoLocationResponseModel.StateOption.IsSet)
                if (geoLocationResponseModel.StateOption.Value != null)
                    writer.WriteString("state", geoLocationResponseModel.State);
                else
                    writer.WriteNull("state");

            if (geoLocationResponseModel.CityOption.IsSet)
                if (geoLocationResponseModel.CityOption.Value != null)
                    writer.WriteString("city", geoLocationResponseModel.City);
                else
                    writer.WriteNull("city");

            if (geoLocationResponseModel.DistrictOption.IsSet)
                if (geoLocationResponseModel.DistrictOption.Value != null)
                    writer.WriteString("district", geoLocationResponseModel.District);
                else
                    writer.WriteNull("district");

            if (geoLocationResponseModel.StreetOption.IsSet)
                if (geoLocationResponseModel.StreetOption.Value != null)
                    writer.WriteString("street", geoLocationResponseModel.Street);
                else
                    writer.WriteNull("street");

            if (geoLocationResponseModel.ZipCodeOption.IsSet)
                if (geoLocationResponseModel.ZipCodeOption.Value != null)
                    writer.WriteString("zipCode", geoLocationResponseModel.ZipCode);
                else
                    writer.WriteNull("zipCode");

            if (geoLocationResponseModel.AddressOption.IsSet)
                if (geoLocationResponseModel.AddressOption.Value != null)
                    writer.WriteString("address", geoLocationResponseModel.Address);
                else
                    writer.WriteNull("address");

            if (geoLocationResponseModel.MapTypeOption.IsSet)
                if (geoLocationResponseModel.MapTypeOption.Value != null)
                    writer.WriteString("mapType", geoLocationResponseModel.MapType);
                else
                    writer.WriteNull("mapType");

            if (geoLocationResponseModel.RemarkOption.IsSet)
                if (geoLocationResponseModel.RemarkOption.Value != null)
                    writer.WriteString("remark", geoLocationResponseModel.Remark);
                else
                    writer.WriteNull("remark");

            if (geoLocationResponseModel.TagsOption.IsSet)
                if (geoLocationResponseModel.TagsOption.Value != null)
                    writer.WriteString("tags", geoLocationResponseModel.Tags);
                else
                    writer.WriteNull("tags");

            if (geoLocationResponseModel.EnableOption.IsSet)
                if (geoLocationResponseModel.EnableOption.Value != null)
                    writer.WriteBoolean("enable", geoLocationResponseModel.EnableOption.Value.Value);
                else
                    writer.WriteNull("enable");

            if (geoLocationResponseModel.ShowIndexOption.IsSet)
                if (geoLocationResponseModel.ShowIndexOption.Value != null)
                    writer.WriteNumber("showIndex", geoLocationResponseModel.ShowIndexOption.Value.Value);
                else
                    writer.WriteNull("showIndex");

            if (geoLocationResponseModel.CreateDateOption.IsSet)
                writer.WriteString("createDate", geoLocationResponseModel.CreateDateOption.Value.Value.ToString(CreateDateFormat));

            if (geoLocationResponseModel.LastUpdateOption.IsSet)
                writer.WriteString("lastUpdate", geoLocationResponseModel.LastUpdateOption.Value.Value.ToString(LastUpdateFormat));

            if (geoLocationResponseModel.IdOption.IsSet)
                writer.WriteNumber("id", geoLocationResponseModel.IdOption.Value.Value);
        }
    }
}
