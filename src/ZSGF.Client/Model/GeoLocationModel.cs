...
namespace ZSGF.Client.Model
{
    ...
    public partial class GeoLocationModel : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GeoLocationModel(Option<double?> latitude = default, Option<double?> longitude = default, Option<string> locationName = default, Option<string> locationType = default, Option<string> recipientName = default, Option<string> phoneNumber = default, Option<string> email = default, Option<string> country = default, Option<string> state = default, Option<string> city = default, Option<string> district = default, Option<string> street = default, Option<string> zipCode = default, Option<string> address = default, Option<string> mapType = default, Option<string> remark = default, Option<string> tags = default, Option<bool?> enable = default, Option<int?> showIndex = default, Option<DateTime?> createDate = default, Option<DateTime?> lastUpdate = default)
        {
    ...
    public class GeoLocationModelJsonConverter : JsonConverter<GeoLocationModel>
    {
        ...
        public override GeoLocationModel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (enable.IsSet && enable.Value == null)
                throw new ArgumentNullException(nameof(enable), "Property is not nullable for class GeoLocationModel.");

            if (showIndex.IsSet && showIndex.Value == null)
                throw new ArgumentNullException(nameof(showIndex), "Property is not nullable for class GeoLocationModel.");
            ...
            return new GeoLocationModel(latitude, longitude, locationName, locationType, recipientName, phoneNumber, email, country, state, city, district, street, zipCode, address, mapType, remark, tags, enable, showIndex, createDate, lastUpdate);
        }
        ...
        {
            if (geoLocationModel.LatitudeOption.IsSet)
                writer.WriteNumber("latitude", geoLocationModel.LatitudeOption.Value.Value);

            if (geoLocationModel.LongitudeOption.IsSet)
                writer.WriteNumber("longitude", geoLocationModel.LongitudeOption.Value.Value);
            ...
            if (geoLocationModel.LocationTypeOption.IsSet)
                if (geoLocationModel.LocationTypeOption.Value != null)
