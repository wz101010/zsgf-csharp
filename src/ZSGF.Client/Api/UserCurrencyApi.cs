...
namespace ZSGF.Client.Api
{
    ...
    public interface IUserCurrencyApi : IApi
    {
        ...
        /// <param name="appKey"></param>
        /// <param name="currencyConsumeRequest"> (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        ...
        /// <param name="signature">签名</param>
        /// <param name="appKey"></param>
        /// <param name="exchangeCurrencyRequest"> (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        ...
        /// <param name="signature">签名</param>
        /// <param name="appKey"></param>
        /// <param name="rechargePointRequest"> (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    ...
    /// </summary>
    public interface IUserCurrenciesApiResponse : ZSGF.Client.Client.IApiResponse, IOk<ZSGF.Client.Model.JObjectApiResult>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IUserCurrencyConsumeApiResponse : ZSGF.Client.Client.IApiResponse, IOk<ZSGF.Client.Model.JObjectApiResult>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IUserCurrencyExchangeApiResponse : ZSGF.Client.Client.IApiResponse, IOk<ZSGF.Client.Model.JObjectApiResult>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IUserCurrencyRechargeApiResponse : ZSGF.Client.Client.IApiResponse, IOk<ZSGF.Client.Model.JObjectApiResult>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IUserCurrencyTransactionsApiResponse : ZSGF.Client.Client.IApiResponse, IOk<ZSGF.Client.Model.JObjectApiResult>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
