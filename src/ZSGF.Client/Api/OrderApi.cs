...
namespace ZSGF.Client.Api
{
    ...
    public interface IOrderApi : IApi
    {
        ...
        /// <param name="skip">拉取的条数 (optional)</param>
        /// <param name="take">跳过的条数 (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    ...
    /// </summary>
    public interface IOrderApiResponse : ZSGF.Client.Client.IApiResponse, IOk<ZSGF.Client.Model.JObjectApiResult>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IOrderCreateApiResponse : ZSGF.Client.Client.IApiResponse, IOk<ZSGF.Client.Model.JObjectApiResult>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IOrdersApiResponse : ZSGF.Client.Client.IApiResponse, IOk<ZSGF.Client.Model.JObjectApiResult>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
