...
namespace ZSGF.Client.Api
{
    ...
    public interface IFileApi : IApi
    {
        ...
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="appKey"></param>
        /// <param name="path">文件或文件夹路径 (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        ...
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="appKey"></param>
        /// <param name="sourceName">原文件或文件夹名称 (optional)</param>
        /// <param name="destName">新文件或文件夹名称 (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
    ...
    /// </summary>
    public interface IFileUploadApiResponse : ZSGF.Client.Client.IApiResponse, IOk<ZSGF.Client.Model.BooleanApiResponse>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
