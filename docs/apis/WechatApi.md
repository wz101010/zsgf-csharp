...
> StringApiResponse WechatGenerateScheme (string appKey, Object body = null)
...
namespace Example
{
    public class WechatGenerateSchemeExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new WechatApi(config);
            var appKey = "appKey_example";  // string | 
            var body = null;  // Object | scheme码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/OpenApiDoc/qrcode-link/url-scheme/generateScheme.html (optional) 
...
# **WechatSubscribeMSG**
> StringApiResponse WechatSubscribeMSG (string appKey, Object body = null)
...
namespace Example
{
    public class WechatSubscribeMSGExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new WechatApi(config);
            var appKey = "appKey_example";  // string | 
            var body = null;  // Object | 订阅消息数据，开发参考：https://dwz.cn/IXptek5n (optional) 
...
# **WechatSubscribeSend**
> StringApiResponse WechatSubscribeSend (string appKey, Object body = null)
...
namespace Example
{
    public class WechatSubscribeSendExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new WechatApi(config);
            var appKey = "appKey_example";  // string | 
            var body = null;  // Object | 订阅消息数据，开发参考：https://dwz.cn/bohXaCnp (optional) 
...
> StringApiResponse WechatUrlLinkGenerate (string appKey, Object body = null)
...
namespace Example
{
    public class WechatUrlLinkGenerateExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new WechatApi(config);
            var appKey = "appKey_example";  // string | 
            var body = null;  // Object | 跳转地址数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/url-link/urllink.generate.html (optional) 
...
# **WechatWXACodeGet**
> System.IO.Stream WechatWXACodeGet (string appKey, Object body = null)
...
namespace Example
{
    public class WechatWXACodeGetExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new WechatApi(config);
            var appKey = "appKey_example";  // string | 
            var body = null;  // Object | 小程序码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/qr-code/wxacode.get.html (optional) 

            try
            {
                // 小程序-获取小程序码
                System.IO.Stream result = apiInstance.WechatWXACodeGet(appKey, body);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // 小程序-获取小程序码
    ApiResponse<System.IO.Stream> response = apiInstance.WechatWXACodeGetWithHttpInfo(appKey, body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> System.IO.Stream WechatWXACodeGetUnlimited (string appKey, Object body = null)
...
namespace Example
{
    public class WechatWXACodeGetUnlimitedExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new WechatApi(config);
            var appKey = "appKey_example";  // string | 
            var body = null;  // Object | 小程序码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/qr-code/wxacode.getUnlimited.html (optional) 

            try
            {
                // 小程序-获取小程序码(无限制)
                System.IO.Stream result = apiInstance.WechatWXACodeGetUnlimited(appKey, body);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // 小程序-获取小程序码(无限制)
    ApiResponse<System.IO.Stream> response = apiInstance.WechatWXACodeGetUnlimitedWithHttpInfo(appKey, body);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
