...
namespace Example
{
    public class FileDeleteExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new FileApi(config);
            var appKey = "appKey_example";  // string | 
            var path = "path_example";  // string | 文件或文件夹路径 (optional) 
...
namespace Example
{
    public class FileRenameExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new FileApi(config);
            var appKey = "appKey_example";  // string | 
            var sourceName = "sourceName_example";  // string | 原文件或文件夹名称 (optional) 
            var destName = "destName_example";  // string | 新文件或文件夹名称 (optional) 
...
<a id="fileupload"></a>
# **FileUpload**
> BooleanApiResponse FileUpload (string appKey, string path = null, System.IO.Stream file = null)
...
namespace Example
{
    public class FileUploadExample
    {
        public static void Main()
        {
            ...
            {
                // 上传文件
                BooleanApiResponse result = apiInstance.FileUpload(appKey, path, file);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // 上传文件
    ApiResponse<BooleanApiResponse> response = apiInstance.FileUploadWithHttpInfo(appKey, path, file);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
